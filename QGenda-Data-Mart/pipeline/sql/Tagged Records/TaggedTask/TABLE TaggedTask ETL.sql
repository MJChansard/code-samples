/*	FILE HEADER
 *		File Name:	TABLE TaggedTask ETL.sql
 *		Author:		Matt Chansard
 *		Project:	QGenda Data Mart
 *
 *	DESCRIPTION
 *		This file contains database object definitions related to the ETL of QGenda Task Tag
 *		records, and which Tags are applied to a Task.  These objects are deployed on 
 *		ANES-ETL1.swmed.org.
 */
 
-- Connect to ANES-ETL1
USE StagingQGenda;
DROP TABLE IF EXISTS stage.TaggedTask;					-- Previous name of object
DROP TABLE IF EXISTS import.qdm_TaggedTask;
CREATE TABLE import.qdm_TaggedTask
(
...
DROP TABLE IF EXISTS stage.qdm_TaggedTask;
CREATE TABLE stage.qdm_TaggedTask
(
	TaskKey							UNIQUEIDENTIFIER
	, InvalidRecordFlag				TINYINT
	-- Tag Category: CA Level
